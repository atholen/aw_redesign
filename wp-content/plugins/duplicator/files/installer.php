...
<div id="content">
	...
	if ($action == 'process') {
		...
		$currdata = parse_url("http://www.auralwes.org"); 
		...
		<form id="form-installer" action="installer.php" method="post" >
			...
			<table width="100%" border="0" cellspacing="2" cellpadding="2" class="table-inputs">
				...
				<tr valign="top">
					...
					<td>
						<input type="text" name="current_url" id="current_url" value="http://www.auralwes.org" readonly="true"  class="readonly" />
				...
				<tr>
					<td>Site Title</td>
					<td><input type="text" name="site_title" id="site_title" value="Aural Wes" /></td>
				</tr>		
				<tr>
					<td></td>
